        ...
        try:
            ...
            if bucket_id.startswith("aw-watcher-afk"):
                ...
                if total_duration.total_seconds() >= 0:
                    trackdata.append(bucket_id.split('_')[-1])
                    rec = { "email": bucket_id.split('_')[-1], "spent_time": total_duration.total_seconds(), "date" : datetime.now().strftime("%m/%d/%Y"), "wfh": False }
